...
function Ra(a){a.d=a.sa.width();a.e=a.sa.height();$("#wrapper").css({width:a.d,height:a.e});a.gd=Math.floor(a.d/2);a.hd=Math.floor(a.e/2);a.Fb=425;a.Eb=318;$(".logo-io-fallback").hasClass("mobile-logo")&&$(".logo-io-fallback").removeClass("mobile-logo");var b=window.devicePixelRatio;if(525>a.d/b||418>a.e/b)a.Fb=318,a.Eb=238,$(".logo-io-fallback").addClass("mobile-logo");a.jd=a.gd-a.Fb/2;a.kd=a.hd-a.Eb/2;$(".bounds-fallback").css({left:a.jd,top:a.kd,width:a.Fb+"px",height:a.Eb+"px"});$(".logo-io-fallback").css({width:a.Fb+
"px",height:a.Eb+"px"});if(a.wa)for(var c in a.wa)a.wa.hasOwnProperty(c)&&(b=a.wa[c],b.V&&(b.V.style.width=a.d+"px",b.V.style.height=a.e+"px"),b.Sa&&b.Sa.F(g))}W.prototype.postMessage=function(a){a.name.match(/.ready/)?this.jc(a):"goToMode"===a.name?Sa(this,a.data,g):"goToHome"===a.name&&Sa(this,"home",g,g)};
