...
n.F=function(a){this.d=$(this.I).width();this.e=$(this.I).height();this.Tc&&(this.Ub=!($.browser.safari&&1024<this.d));var b=1;this.Ub&&(1024===this.d&&(this.d-=2,this.e-=2),b=2);this.log("Resize "+this.d+"x"+this.e);this.d>this.e?(this.Ab=Math.min(375,this.e-60-20),this.u=this.Ab*(4/3)):(this.u=Math.min(500,this.d-60),this.Ab=0.75*this.u);this.dd=Math.floor(this.d/2);this.ed=Math.floor(this.e/2);this.Pa=this.dd-Math.floor(this.u/2);this.Qa=this.ed-Math.floor(this.Ab/2);this.cd.css({left:this.Pa,
top:this.Qa,width:this.u,height:this.Ab});this.k&&(paper=this.rb,this.k.width=this.d*b,this.k.height=this.e*b,paper.view.setViewSize(this.d*b,this.e*b),$(this.k).css({width:this.d,height:this.e}));a&&z(this)};n.vd=function(a){this.Za+=a;a*=0.0010;0.5<a&&(a=0.016);this.vc&&this.qa(a);TWEEN.update(this.Za);this.uc&&this.M(a);this.cc++};function z(a){a.uc&&a.M(0)}n.M=function(){if(this.k){var a=1;this.Ub&&(a=2);paper=this.rb;var b=this.k.getContext("2d");b.save();b.scale(a,a);paper.view.draw();b.restore()}};
...
a.q/2&&Math.abs(b.y-a.b.position.y)<a.J/2?a.hasFocus&&(a.i.style.cursor="pointer"):a.i.style.cursor="default"})};n.z=function(){E.c.z.call(this);x(this,$(this.k),"down");x(this,$(this.k),"move")};n.F=function(a){E.c.F.call(this,k);this.Hc&&(this.Gb=!($.browser.safari&&1024<this.d));va(this);this.Y();this.Z();6*this.e<this.d&&this.l("error.mp3");var b=1;this.Gb&&(b=2);this.i.width=this.d*b;this.i.height=this.e*b;$(this.i).css({width:this.d,height:this.e});a&&z(this)};
...
n.qa=function(a){E.c.qa.call(this,a);this.b&&this.a&&(this.jb(),this.kb(),this.Da(this.b),this.Ca(this.b),this.Da(this.a),this.Ca(this.a),this.Gb?(this.b.scale(0.65),this.a.scale(0.65)):(this.b.scale(0.55),this.a.scale(0.55)))};
n.M=function(a){E.c.M.call(this,a);var b=this.k,c=this.i;if(b.width&&!(1>b.width)&&b.height&&!(1>b.height)){var d=b.getContext("2d");a=c.getContext("2d");b=d.getImageData(0,0,b.width,b.height);a.clearRect(0,0,c.width+1,c.height+1);c=~~(0.0625*this.d);6*this.e<this.d&&(c/=8);d=Math.min(Math.round(80*c)/4,980);paper=this.rb;var e=1;this.Gb&&(e=2);a.save();a.scale(e,e);for(i=0;i<b.data.length;i+=d)if(0!==b.data[i+3]){var f=Math.ceil(i/4),e=f%this.d,f=Math.floor(f/this.d);a.fillStyle="rgba("+b.data[i]+
...
this.x+"px, "+this.y+"px) ",b=b+("scale("+this.scale+")");a.X[0].style[a.ca]=b});C(this,c);C(this,b)};function G(a,b){A(this,"bacon-sizzle.mp3");A(this,"egg-cracked.mp3");A(this,"cracked-open.mp3");A(this,"eggs-sizzling.mp3");q.call(this,a,b,"bacon",g,g,k)}p(G);G.prototype.n=function(){G.c.n.call(this);this.$c=g;this.fd=$("#egg-whole").css("opacity",1)[0];this.Ec=$("[id*=crack-]").css("opacity",0);this.$b=0;this.Cd=this.Ec.length;this.Gd=$("#egg-whites");this.Ra=$("#egg-cracked").css("opacity",0);this.Cc=this.Ra.attr("cx")+", "+this.Ra.attr("cy")};
...
") translate(0, "+this.translateY+")")});C(this,b);C(this,c)};G.prototype.m=function(){G.c.m.call(this);if(this.$b<this.Cd)this.Ec[this.$b].style.opacity=1,this.$b++,this.l("egg-cracked.mp3");else if(this.$c){this.l("cracked-open.mp3");var a=this,b=new TWEEN.Tween({opacity:1});b.to({opacity:0},200);b.onUpdate(function(){a.fd.style.opacity=this.opacity});b.onComplete(function(){a.Ra.css("opacity",1);a.$c=k;wa(a)});this.Ra.css("opacity",0);C(this,b)}else this.l("eggs-sizzling.mp3"),wa(this)};
...
I.prototype.m=function(){I.c.m.call(this);this.cb<this.Nc&&(this.zb[this.cb].style.opacity=1,this.cb++,this.l("bite-1.mp3"));if(this.Ua&&this.cb===this.Nc){var a=this,b=new TWEEN.Tween({opacity:0});b.to({opacity:1},200);b.delay(500);b.onStart(function(){a.zb.css("opacity",0)});b.onUpdate(function(){a.X.css("opacity",this.opacity)});b.onComplete(function(){a.Ua=g;a.cb=0});this.Ua=k;C(this,b)}};function xa(a){this.da="";this.Oc=15;var b={},c,d;for(c in a)a.hasOwnProperty(c)&&a[c].pattern&&(d=a[c],b[c]={Va:d.Va,Yb:ca(d.pattern.toString(2),d.nb)});this.hc=[];for(c in b)if(b.hasOwnProperty(c)){d=b[c];for(a=0;a<d.Yb.length;a++)this.hc.push({key:c,Nb:RegExp("^"+d.Yb.slice(0,a+1)),Lb:a+1!=d.Yb.length})}}xa.prototype.reset=function(){this.da=""};function J(a,b){A(this,"i.mp3");A(this,"o.mp3");q.call(this,a,b,"home",g,g,k,g);this.Qb=new xa(v);this.bd=0;this.Kb=g;this.rd=12E3}p(J);function ya(a){a.Kb=g;a.xc.fadeIn(300);a.T.fadeOut(300)}
function za(a,b){a.T.hasClass("success")&&(a.T.removeClass("success"),a.Qb.reset());a.T.hasClass("failure")&&(a.T.removeClass("failure"),a.Qb.reset());var c=a.Qb;c.da+=b;c.da.length>c.Oc&&(c.da=c.da.slice(-c.Oc,c.da.length));var d=c.da,e;a:{e=[];for(var f=0;f<c.hc.length;f++){var l=c.hc[f],j=l.Nb.toString().length-3;if(j===c.da.length&&l.Nb.test(c.da)&&(e.push({Nb:l,nb:j,Lb:l.Lb}),!l.Lb)){e=l;break a}}for(var y,f=c=0;f<e.length;f++)e[f].nb>c&&(y=e[f].Nb,c=e[f].nb);e=y}a.log("current pattern: "+d);
d=d.replace(/1/g,'<span class="i"></span>').replace(/0/g,'<span class="o"></span>');a.T.html(d);a.T.css("marginLeft",-((a.T.width()+15)/2));e?(a.log("matched",e),e.Lb||(a.T.addClass("success"),d=e.key,a.ra("matched-pattern",d),ra("goToMode",d))):(a.T.removeClass("success"),a.T.addClass("failure"));a.Kb&&(a.Kb=k,a.xc.fadeOut(300),a.T.fadeIn(300));a.bd=a.Za}n=J.prototype;n.p=function(){J.c.p.call(this);this.za(this.b,this.t,10);this.l("i.mp3");za(this,"1")};
n.m=function(){J.c.m.call(this);this.za(this.a,this.t,10);this.l("o.mp3");za(this,"0")};n.Y=function(){this.b&&this.b.remove();var a=new paper.Point(this.fa,this.ga),b=new paper.Size(this.q,this.J),a=new paper.Rectangle(a,b);this.b=new paper.Path.Rectangle(a);this.b.closed=g;this.b.vectors=[];for(a=0;a<this.b.segments.length;a++)b=this.b.segments[a].point.clone(),b=b.subtract(this.W),b.velocity=0,b.acceleration=5*Math.random()+10,b.bounce=0.1*Math.random()+1.05,this.b.vectors.push(b)};
n.jb=function(){var a=new paper.Gradient([["#4487fc",0],["#826eb1",1]]),b=this.b.position.clone();b.x-=this.q/2;var c=this.b.position.clone();c.x+=this.q/2;a=new paper.GradientColor(a,b,c);this.b.fillColor=a};
n.Z=function(){this.a&&this.a.remove();this.a=new paper.Path.RegularPolygon(this.A,6,this.g);this.a.smooth();this.a.vectors=[];for(var a=0;a<this.a.segments.length;a++){var b=this.a.segments[a].point.clone(),b=b.subtract(this.A);b.velocity=0;b.acceleration=5*Math.random()+10;b.bounce=0.1*Math.random()+1.05;this.a.vectors.push(b)}};
n.kb=function(){var a=new paper.Gradient([["#93689c",0],["#df4a40",1]]),b=this.a.position.clone();b.x-=this.g;var c=this.a.position.clone();c.x+=this.g;a=new paper.GradientColor(a,b,c);this.a.fillColor=a};n.n=function(){J.c.n.call(this);this.xc=this.find("#date");this.T=this.find("#pattern");this.Qb.reset();B(this);this.t=new paper.Point(this.Xa,this.xa);0<this.k.height&&(this.Y(),this.Z())};
...
n.Da=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b],d=new paper.Point(this.fa,this.ga);c.velocity=a===this.a?((this.g-c.length)/c.acceleration+c.velocity)/c.bounce:((d.getDistance(this.W)-c.length)/c.acceleration+c.velocity)/c.bounce;c.length=Math.max(0,c.length+c.velocity)}};n.Ca=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b].clone();a===this.a?(this.a.segments[b].point=c.add(this.A),this.a.smooth()):this.b.segments[b].point=c.add(this.W)}};
n.M=function(a){J.c.M.call(this,a);this.Kb||this.Za-this.bd>this.rd&&ya(this);this.b&&this.a&&(this.jb(),this.kb());0<a&&(this.b&&this.a)&&(this.Da(this.b),this.Ca(this.b),this.Da(this.a),this.Ca(this.a))};function K(a,b){q.call(this,a,b,"simone",g,g)}p(K);
...
n.l=function(a,b,c,d){if(this.H){b=this.Xb+"sounds/"+this.j+"/"+a;this.log('Playing sound "'+a+'"');a=this.la;b=ta(this,b);var e=a.createBufferSource(),f=a.createGainNode();f.gain.value=0.1;e.buffer=b;e.loop=d||k;e.connect(f);f.connect(this.Cb.input);this.Cb.connect(a.destination);e.noteOn(0);"function"===typeof c&&c(e)}};n.p=function(){this.Hb=g;10>this.K&&(this.K+=2);this.l("i.mp3")};n.m=function(){this.Ob=g;10>this.L&&(this.L+=2);this.l("o.mp3")};
...
n.M=function(a){L.c.M.call(this,a);var b;if(this.i){var c=this.i.getContext("2d");c.fillStyle="#e4e4e4";c.clearRect(0,0,this.i.width+1,this.i.height+1);for(b=0;b<this.h.particles.length;b++)c.beginPath(),c.arc(this.h.particles[b].pos.x+0.5,this.h.particles[b].pos.y+0.5,this.h.particles[b].radius,0,2*Math.PI),c.closePath(),c.fill();this.Db=a/100;if(this.Hb===g){Fa(this,this.ea,this.Jc,this.K,this.Hb,g);this.H&&(this.Cb.feedback=this.K/10);for(b=0;b<this.C.length;b++)this.Ba=aa(),this.C[b].segments[0].point.x=
...
n.n=function(){P.c.n.call(this);this.B=s("down","synth");this.s=s("up","synth");var a=this.la;this.source=a.createOscillator();this.gain=a.createGainNode();this.gain.gain.value=0.01;this.tc=new Tuna(a);this.O=a.createAnalyser();this.O.fftSize=512;this.O.smoothingTimeConstant=0.85;this.Vb=$("#waveforms");this.Pd=document.getElementById("oscillator-frequency");this.detune=document.getElementById("oscillator-detune");this.R=k;this.bc={};this.bc.delay=new this.tc.Delay;Ga(this);this.count=360*(this.d%
360);this.Mb=$("#synth-letter-i");this.ha=$("#synth-letter-o");this.$a=1;this.fc=80;this.Lc=650;this.md=0;this.od=this.nd=0.5;this.Fd=["sine","square","saw","triangle"];var b=this;setTimeout(function(){b.F(g)},800)};
...
n.F=function(a){P.c.F.call(this,k);this.hb=500>this.e?this.e/2+(this.e-256)/2:this.e/2+128;this.scale=~~(0.5*this.e);this.Ed=~~(this.e/2);this.i&&(this.i.width=this.d,this.i.height=this.e);this.pb=this.ha.offset();this.Pb=this.ha[0].getBoundingClientRect().width;this.g=this.Pb/2;this.Ia=this.pb.left+this.g;this.qb=this.pb.top+this.g;this.na&&this.S&&(this.Jd=this.na.position.x,this.Kd=this.na.position.y,this.Bb=this.na.bounds.width/2,this.na.position.x=this.Ia,this.na.position.y=this.qb,this.na.scale(this.g/
this.Bb),this.ib.position.x=this.Ia,this.ib.position.y=this.qb,this.ib.scale(this.g/this.Bb),this.Bb=this.S.bounds.width/2,this.S.position.x=this.Ia,this.S.position.y=this.qb,this.S.scale(0.08*this.g/this.Bb));if(this.N){Math.max(2*this.g,128);for(var b=2*this.g/128,c=0,d=this.N.length;c<d;c++)for(var e=0,f=this.N[c].segments.length;e<f;e++)this.N[c].segments[e].point.x=b*e+this.Ia-this.g,this.N[c].segments[e].point.y=this.hb}a&&z(this);a=this.Mb[0].getBoundingClientRect();var b=this.Mb.position(),
l=~~a.height;this.Vb.css({top:~~b.top+"px",left:~~b.left+"px",height:l+"px",width:~~a.width+"px"});var j=this;setTimeout(function(){var a=j.Vb.find("li"),b=a.height();a.css("margin-top",~~((l-4*b)/4.5))},100)};
...
new paper.RgbColor(255,255,255,0.2);a.path.strokeWidth=5;for(var c=0;128>=c;c++){var d=new paper.Point(b*c+a.Ia-a.g,a.hb);a.path.add(d)}a.N=[];a.N.push(a.path);for(b=0;3>b;b++)c=a.path.clone(),a.N.push(c);a.ud=new paper.Group(a.na,a.N[0],a.N[1],a.N[2],a.N[3],a.S);a.ud.clipped=g;a.duration=0}a.R=k;Ha(a);a.Mb.bind(this.s,function(){a.$a++;a.$a=3<a.$a?0:a.$a;Ga(a);$(".on",a.Vb).removeClass("on");$("."+a.Fd[a.$a],a.Vb).addClass("on")});a.ha.bind(this.B,function(){a.Rc=g;a.fc=Ia(a,event.pageX,event.pageY)});
a.ha.bind(this.s,function(){Ja(a);Ka(a);a.Rc=k});b=s("move",this.j);a.ha.bind(b,function(){a.Rc&&(Ja(a),Ka(a))});a.pb=a.ha.offset();a.Pb=a.ha[0].getBoundingClientRect().width};n.z=function(){P.c.z.call(this);this.Mb.unbind(this.s);this.ha.unbind(this.B);this.ha.unbind(this.s);var a=s("move",this.j);this.ha.unbind(a);this.R=g;Ha(this)};function Ga(a){a.source.type=a.$a;a.source.frequency.value=a.fc;a.source.detune.value=a.Lc}
function Ha(a){if(a.R)a.source.disconnect(),a.R=k;else{var b=a.la;a.source.connect(a.bc.delay.input);a.bc.delay.connect(a.O);a.O.connect(a.gain);a.gain.connect(b.destination);a.source.noteOn(0);a.R=g}}function Ja(a){var b=event;Ia(a,b.pageX,b.pageY);Ga(a)}function Ka(a){var b=event;a.S.position.x=b.pageX;a.S.position.y=b.pageY}function Ia(a,b,c){b=(b-a.pb.left)/a.Pb;c=(c-a.pb.top)/a.Pb;a.fc=1E3-1E3*c;a.Lc=-4800+9600*b;a.md=60-60*c;a.od=c;a.nd=b};function Q(a,b){A(this,"rocket-launch.mp3");A(this,"rumble.mp3");A(this,"sci-fi-door.mp3");q.call(this,a,b,"rocket",g,g,k);var c=this.find(".letter-i"),d=this.find(".letter-o");this.zc=d.attr("cx")+", "+d.attr("cy");this.gb=c.attr("cx")+", "+c.attr("cy");this.nc=this.find(".letter-i-wrapper");this.ic=$("#moon-1");this.lb=$("[id*=fire-]").css("opacity",0);this.qd=this.lb.length;this.ua=0;this.Ib=this.ec=k}p(Q);
Q.prototype.p=function(){Q.c.p.call(this);if(!this.Ib)if(this.ua<this.qd){if(!this.Ib){var a=this;this.l("rumble.mp3");this.lb[this.ua].style.opacity=1;this.lb[this.ua+1].style.opacity=1;this.lb[this.ua+2].style.opacity=1;var b=~~Random(2,2*this.ua+2),c=new TWEEN.Tween({rotate:0});c.to({rotate:-b},100);c.onUpdate(function(){a.o.attr("transform","rotate("+this.rotate+", "+a.gb+")")});var d=new TWEEN.Tween({rotate:-b});d.to({rotate:b},200);d.delay(100);d.onUpdate(function(){a.o.attr("transform","rotate("+
this.rotate+", "+a.gb+")")});b=new TWEEN.Tween({rotate:b});b.to({rotate:0},100);b.delay(300);b.onUpdate(function(){a.o.attr("transform","rotate("+this.rotate+", "+a.gb+")")});b.onComplete(function(){a.ua+=3;a.Ib=k});this.Ib=g;C(this,c);C(this,d);C(this,b)}}else if(!this.ec){this.l("rocket-launch.mp3");var e=this,c=100,d=this.X[0].getBoundingClientRect(),b=this.o[0].getBoundingClientRect(),f=~~(d.left+d.width/2-b.height);prevTransform=transform="";(new TWEEN.Tween({translateY:0})).to({translateY:20},
...
function La(a){a.La?(a.Tb.x=a.Xc,a.Tb.y=a.Yc,a.Sb.x=a.Vc,a.Sb.y=a.Wc,a.La.segments[0].point=a.Tb,a.La.segments[1].point=a.Sb,a.La.strokeWidth=a.Zc):(a.Tb=new paper.Point(a.Xc,a.Yc),a.Sb=new paper.Point(a.Vc,a.Wc),a.La=new paper.Path,a.La.strokeWidth=a.Zc,a.La.strokeColor="#ebebeb",a.La.add(a.Tb,a.Sb))}n.n=function(){R.c.n.call(this);this.h=ua(this);B(this,g);this.t=new paper.Point(this.Xa,this.xa);0<this.k.height&&(La(this),this.Y(),this.Z())};
...
n.w=function(){S.c.w.call(this);this.Oa=document.getElementById("bonus");this.Wb=$("#score");this.v=$("#pong-canvas");this.i=this.v[0];this.i.width=this.d;this.i.height=this.e;this.r=this.i.getContext("2d");var a=this,b=s("move",this.j);this.v.bind(b,function(b){b.preventDefault();b.stopPropagation();a.ob=D(b).x;a.Ga=D(b).y});this.dc=this.dc||0;this.dc++;Pa(this,0);this.Oa.style.opacity=0;this.Oa.style[this.ca]="translateX(50px)";this.Rb=k};n.z=function(){S.c.z.call(this);var a=s("move",this.j);this.v.unbind(a)};
function Qa(a,b){a.l("1.mp3");var c=b+"Opacity_",d={};d[c]=a[c];var e={};e[c]=1;d=new TWEEN.Tween(d);d.to(e,200);d.onUpdate(function(){a[c]=this[c]});C(a,d)}function Pa(a,b){a.oc=b;a.Wb&&a.Wb.length&&a.Wb.text(a.oc)}
n.qa=function(a){if(!this.Rb){S.c.qa.call(this,a);var b=this.Ka,c=this.Ga;c<this.ja/2?c=this.ja/2:c>this.e-this.ja/2&&(c=this.e-this.ja/2);this.Ka=b+0.7*(c-b)*10*a;0<this.f.vel.x&&(this.Ea>=this.sd&&(this.Ea*=0.9995,this.f.setRadius(this.Ea)),this.ma<=this.pd&&(this.ma*=1.001,this.f.vel.x=this.ma,this.f.vel.y=0>this.f.vel.y?-this.ma:this.ma));if(this.f.pos.x<=this.f.radius){var d=this;d.log("You Lose");d.ra("lost",d.oc);d.ra("game number",d.dc);d.Rb=g;sa(d,function(){Oa(d);d.Rb=k})}else if(0<this.f.vel.x&&
this.f.pos.x>=this.d-this.f.radius&&(this.f.vel.x*=-1,Qa(this,"rightWall")),0<this.f.vel.y&&this.f.pos.y>=this.e-this.f.radius&&(this.f.vel.y*=-1,Qa(this,"bottomWall")),0>this.f.vel.y&&this.f.pos.y<=this.f.radius&&(this.f.vel.y*=-1,Qa(this,"topWall")),a=this.Ka-this.ja/2,b=this.Ka+this.ja/2,0>this.f.vel.x&&this.f.pos.x<=this.Sc+this.kc/2+this.f.radius&&this.f.pos.y>=a&&this.f.pos.y<=b){this.f.vel.x*=-1;a=this.f.vel.mag();this.Ha?this.Ha.copy(this.f.vel):this.Ha=this.f.vel.clone();this.Ha.norm();this.Zb=
this.Zb||new Vector;this.Zb.set(0,(this.f.pos.y-this.Ka)/(this.ja/2));this.Ha.add(this.Zb);this.Ha.norm();this.Ha.scale(a);this.f.vel.copy(this.Ha);var e=this;e.l("2.mp3");a=e.oc+1;0<e.topWallOpacity_&&(0<e.rightWallOpacity_&&0<e.bottomWallOpacity_)&&(a+=10,b=new TWEEN.Tween({opacity:0,translateX:50}),b.to({opacity:1,translateX:0},200),b.onUpdate(function(){e.Oa.style.opacity=this.opacity;e.Oa.style[e.ca]="translateX("+this.translateX+"px)"}),c=new TWEEN.Tween({opacity:1,translateX:0}),c.to({opacity:0,
...
function Ra(a){a.d=a.sa.width();a.e=a.sa.height();$("#wrapper, #unsupported").css({width:a.d,height:a.e});a.gd=Math.floor(a.d/2);a.hd=Math.floor(a.e/2);a.Fb=395;a.Eb=299;$(".logo-io-fallback").hasClass("mobile-logo")&&$(".logo-io-fallback").removeClass("mobile-logo");var b=window.devicePixelRatio;if(495>a.d/b||399>a.e/b)a.Fb=262,a.Eb=199,$(".logo-io-fallback").addClass("mobile-logo");a.jd=a.gd-a.Fb/2;a.kd=a.hd-a.Eb/2;$(".bounds-fallback").css({left:a.jd,top:a.kd,width:a.Fb+"px",height:a.Eb+"px"});
$(".logo-io-fallback").css({width:a.Fb+"px",height:a.Eb+"px"});if(a.wa)for(var c in a.wa)a.wa.hasOwnProperty(c)&&(b=a.wa[c],b.V&&(b.V.style.width=a.d+"px",b.V.style.height=a.e+"px"),b.Sa&&b.Sa.F(g))}W.prototype.postMessage=function(a){a.name.match(/.ready/)?this.jc(a):"goToMode"===a.name?Sa(this,a.data,g):"goToHome"===a.name&&Sa(this,"home",g,g)};
