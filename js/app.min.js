...
r&&$(function(){var a=window.location.href.split("/"),b=a[a.length-1].replace("_test.html",".html").replace(/\.html(.*)/,"");if((a=v[b])&&a.Va){var c=$(window).width(),d=$(window).height();1>d&&(d=c);b=$("<div></div>").addClass("mode").addClass(b+"-mode");b.css({width:c,height:d});$("body > *").wrapAll(b);window.currentMode=new a.Va($(".mode")[0],r?"../../":"../");$(window).resize(ea(function(){$(".mode").css({width:$(window).width(),height:$(window).height()});window.currentMode.F(g)}))}});function W(){if(!Modernizr.svg||!Modernizr.csstransforms||!Modernizr.canvas)$(document.body).addClass("unsupported");else{this.qc=Modernizr.prefixed("transform");this.sa=$(window);this.e=this.d=0;var a=this;this.sa.resize(ea(function(){Ra(a)}));Ra(this);if(Modernizr.touch){document.body.style[Modernizr.prefixed("userSelect")]="none";document.body.style[Modernizr.prefixed("userDrag")]="none";document.body.style[Modernizr.prefixed("tapHighlightColor")]="rgba(0,0,0,0)";var b=s("move","app");this.sa.bind(b,
function(a){a.preventDefault();a.stopPropagation()});b=s("up","app");this.sa.bind(b,function(a){a.preventDefault();a.stopPropagation()});b=s("down","app");this.sa.bind(b,function(a){a.preventDefault();a.stopPropagation()});this.sa.bind("dblclick.app",function(a){a.preventDefault();a.stopPropagation()})}a.hc=m();Sa(a,"home",k)}}
function Ra(a){a.d=a.sa.width();a.e=a.sa.height();$("#wrapper").css({width:a.d,height:a.e});if(a.wa)for(var b in a.wa)if(a.wa.hasOwnProperty(b)){var c=a.wa[b];c.V&&(c.V.style.width=a.d+"px",c.V.style.height=a.e+"px");c.Sa&&c.Sa.F(g)}}W.prototype.postMessage=function(a){a.name.match(/.ready/)?this.hc(a):"goToMode"===a.name?Sa(this,a.data,g):"goToHome"===a.name&&Sa(this,"home",g,g)};
