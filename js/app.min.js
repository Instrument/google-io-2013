...
n.F=function(a){this.d=$(this.I).width();this.e=$(this.I).height();this.Rc&&(this.Sb=!($.browser.safari&&1024<this.d));var b=1;this.Sb&&(1024===this.d&&(this.d-=2,this.e-=2),b=2);this.log("Resize "+this.d+"x"+this.e);this.d>this.e?(this.Ab=Math.min(375,this.e-60-20),this.u=this.Ab*(4/3)):(this.u=Math.min(500,this.d-60),this.Ab=0.75*this.u);this.bd=Math.floor(this.d/2);this.cd=Math.floor(this.e/2);this.Pa=this.bd-Math.floor(this.u/2);this.Qa=this.cd-Math.floor(this.Ab/2);this.ad.css({left:this.Pa,
top:this.Qa,width:this.u,height:this.Ab});this.k&&(paper=this.rb,this.k.width=this.d*b,this.k.height=this.e*b,paper.view.setViewSize(this.d*b,this.e*b),$(this.k).css({width:this.d,height:this.e}));a&&z(this)};n.pd=function(a){this.Za+=a;a*=0.0010;0.5<a&&(a=0.016);this.tc&&this.qa(a);TWEEN.update(this.Za);this.sc&&this.M(a);this.ac++};function z(a){a.sc&&a.M(0)}n.M=function(){if(this.k){var a=1;this.Sb&&(a=2);paper=this.rb;var b=this.k.getContext("2d");b.save();b.scale(a,a);paper.view.draw();b.restore()}};
n.postMessage=function(a){this.log("Got message: "+a.name,a);"focus"===a.name?qa(this):"unfocus"===a.name&&this.hasFocus&&(this.log("Lost focus"),this.hasFocus=k,this.Zc&&(delete u[this.j],oa()),this.z())};function ra(a,b){window.app&&window.app.postMessage&&window.app.postMessage({name:a,data:b})}n.ra=function(a,b){da("mode-"+this.Bd,a,b)};function qa(a){a.hasFocus||(a.k&&(paper=a.rb),a.ed&&a.n(),a.uc(),a.log("Got focus"),a.hasFocus=g,a.Zc&&(a.ac=0,a.Za=0,u[a.j]=[a,a.pd],oa()),a.w())}n.uc=m();
...
function va(a){a.q=0.2*a.u;a.J=0.43058824*a.u;a.fa=a.Pa+0.10352941*a.u;a.ga=a.Qa+0.16*a.u;a.W=new paper.Point(a.fa+a.q/2,a.ga+a.J/2);a.g=0.22588235*a.u;a.Xa=a.Pa+0.69647059*a.u;a.xa=a.Qa+0.37411765*a.u;a.A=new paper.Point(a.Xa,a.xa);a.Vc=a.Pa+0.50352941*a.u;a.Wc=a.Qa+0.06823529*a.u;a.Tc=a.Pa+0.32*a.u;a.Uc=a.Qa+0.68705882*a.u;a.Xc=0.02212389*a.u;a.find(".year-mark")&&a.find(".year-mark").css({left:a.Pa+0.85411765*a.u,top:a.Qa+0.08705882*a.u})};function E(a,b){A(this,"i.mp3");A(this,"o.mp3");A(this,"error.mp3");q.call(this,a,b,"eightbit",g,g,g,k);this.Eb=this.Fc=1<window.devicePixelRatio;this.i=document.getElementById("eightbit-canvas")}p(E);n=E.prototype;n.p=function(){E.c.p.call(this);this.za(this.b,this.t,10);this.l("i.mp3")};n.m=function(){E.c.m.call(this);this.za(this.a,this.t,10);this.l("o.mp3")};
...
a.q/2&&Math.abs(b.y-a.b.position.y)<a.J/2?a.hasFocus&&(a.i.style.cursor="pointer"):a.i.style.cursor="default"})};n.z=function(){E.c.z.call(this);x(this,$(this.k),"down");x(this,$(this.k),"move")};n.F=function(a){E.c.F.call(this,k);this.Fc&&(this.Eb=!($.browser.safari&&1024<this.d));va(this);this.Y();this.Z();6*this.e<this.d&&this.l("error.mp3");var b=1;this.Eb&&(b=2);this.i.width=this.d*b;this.i.height=this.e*b;$(this.i).css({width:this.d,height:this.e});a&&z(this)};
...
this.x+"px, "+this.y+"px) ",b=b+("scale("+this.scale+")");a.X[0].style[a.ca]=b});C(this,c);C(this,b)};function G(a,b){A(this,"bacon-sizzle.mp3");A(this,"egg-cracked.mp3");A(this,"cracked-open.mp3");A(this,"eggs-sizzling.mp3");q.call(this,a,b,"bacon",g,g,k)}p(G);G.prototype.n=function(){G.c.n.call(this);this.Yc=g;this.dd=$("#egg-whole").css("opacity",1)[0];this.Cc=$("[id*=crack-]").css("opacity",0);this.Yb=0;this.wd=this.Cc.length;this.Ad=$("#egg-whites");this.Ra=$("#egg-cracked").css("opacity",0);this.Ac=this.Ra.attr("cx")+", "+this.Ra.attr("cy")};
...
") translate(0, "+this.translateY+")")});C(this,b);C(this,c)};G.prototype.m=function(){G.c.m.call(this);if(this.Yb<this.wd)this.Cc[this.Yb].style.opacity=1,this.Yb++,this.l("egg-cracked.mp3");else if(this.Yc){this.l("cracked-open.mp3");var a=this,b=new TWEEN.Tween({opacity:1});b.to({opacity:0},200);b.onUpdate(function(){a.dd.style.opacity=this.opacity});b.onComplete(function(){a.Ra.css("opacity",1);a.Yc=k;wa(a)});this.Ra.css("opacity",0);C(this,b)}else this.l("eggs-sizzling.mp3"),wa(this)};
function wa(a){var b=-1*~~(250*Math.random()+20),c=a.Ra.attr("transform")||"",c=parseInt(c.split("rotate(")[1],10)||0,d=~~Random(-20,20),e=new TWEEN.Tween({rotate:c});e.to({rotate:(c+b/2)/window.devicePixelRatio},500);e.easing(TWEEN.Easing.Elastic.In);e.onUpdate(function(){a.Ad.attr("transform","rotate("+(this.rotate-d)+", "+a.Ac+")");a.Ra.attr("transform","rotate("+this.rotate+", "+a.Ac+")")});C(a,e)};function H(a,b){A(this,"brass-note-1.mp3");A(this,"brass-note-2.mp3");A(this,"brass-note-3.mp3");A(this,"brass-note-4.mp3");A(this,"lute-note-1.mp3");A(this,"lute-note-2.mp3");A(this,"lute-note-3.mp3");A(this,"lute-note-4.mp3");A(this,"funky-note-1.mp3");A(this,"funky-note-2.mp3");A(this,"funky-note-3.mp3");A(this,"funky-note-4.mp3");A(this,"beats-piano.mp3");A(this,"beats-club.mp3");A(this,"beats-effected-kit.mp3");A(this,"beats-electric-1.mp3");A(this,"beats-electric-2.mp3");A(this,"beats-hip-hop.mp3");
...
n.Da=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b],d=new paper.Point(this.fa,this.ga);c.velocity=a===this.a?((this.g-c.length)/c.acceleration+c.velocity)/c.bounce:((d.getDistance(this.W)-c.length)/c.acceleration+c.velocity)/c.bounce;c.length=Math.max(0,c.length+c.velocity)}};n.Ca=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b].clone();a===this.a?(this.a.segments[b].point=c.add(this.A),this.a.smooth()):this.b.segments[b].point=c.add(this.W)}};
n.M=function(a){J.c.M.call(this,a);this.Ib||this.Za-this.$c>this.ld&&ya(this);this.b&&this.a&&(this.jb(),this.kb());0<a&&(this.b&&this.a)&&(this.Da(this.b),this.Ca(this.b),this.Da(this.a),this.Ca(this.a))};function K(a,b){q.call(this,a,b,"simone",g,g)}p(K);
K.prototype.n=function(){K.c.n.call(this);var a=this;TWEEN.removeAll();this.B=s("down","simone");this.s=s("up","simone");this.sd=Modernizr.touch?"Tap":"Click";this.ub=$("#red");this.vb=$("#green");this.eb=$("#blue");this.fb=$("#yellow");this.pc=[this.ub,this.vb,this.eb,this.fb];this.oc=$("#red, #green, #blue, #yellow").css("opacity",1);this.ec=$("#levels").removeClass().text("");this.Ma=$("#status").removeClass();this.xd=$("#levels").css("opacity",0);this.Bc=$("#simone");this.message=$("#message").text(this.sd+
" to play.");this.Bc.bind(this.s,function(){a.message.hide();Aa(a);a.Bc.unbind(a.s)});this.jc=0;this.Ta=this.R=k;this.Gc=this.Fa=this.Aa=0;this.G=this.G||[];for(var b=0;4>b;b++)this.G.push(~~(4*Math.random()));this.log("generated sequence: "+this.G);this.total=this.G.length;this.H&&(b=this.la,this.source=b.createOscillator(),this.O=b.createAnalyser(),this.O.fftSize=512,this.O.smoothingTimeConstant=0.85,this.mb=b.createGainNode(),this.mb.gain.value=0.01,this.Nc=[{frequency:1806,detune:-3663,type:1},
...
function Ba(a,b){if(a.R&&!a.Ta){0===a.Aa&&a.Ma.removeClass("your-turn");var c=a.Nc[b],d=a.pc[b];a.H&&(a.log("Playing note: ",c),a.source.type=c.type,a.source.frequency.value=c.frequency,a.source.detune.value=c.detune);c=new TWEEN.Tween({opacity:0.5});c.to({opacity:1},100);if(a.H)c.onStart(function(){a.source.connect(a.O);a.O.connect(a.mb);a.mb.connect(a.la.destination);a.source.noteOn(0)});c.onUpdate(function(){d.css("opacity",this.opacity)});C(a,c)}}
function Ca(a,b){a.log("Guess ("+b+"). Expecting ("+a.G[a.Aa]+")");if(a.R&&!a.Ta){var c=a.pc[b],d=a.H?200:400,e=new TWEEN.Tween({opacity:1});e.to({opacity:0.5},d);e.onUpdate(function(){c.css("opacity",this.opacity)});if(a.H)e.onComplete(function(){a.source.disconnect()});else e.delay(200);C(a,e);a.Ta=k;if(a.G[a.Aa]===b)if(a.Aa!==a.Fa)a.Aa++;else{a.Fa++;a.Ma.addClass("success");if(a.Fa===a.total){for(d=0;4>d;d++)a.G.push(~~(4*Math.random()));a.total+=4}a.Fa<a.total&&(a.Aa=0);Da(a)}else a.R=k,a.Ma.addClass("game-over"),
a.ra("failed",a.G.length),d=new TWEEN.Tween({opacity:0.5}),d.to({opacity:1},200),d.delay(500),d.onUpdate(function(){a.oc.css("opacity",this.opacity)}),d.onComplete(function(){a.Ma.removeClass();sa(a,function(){Aa(a)},g)}),C(a,d)}}
function Aa(a){if(!a.R){a.jc++;a.R=g;a.Ta=k;a.Aa=0;a.Gc=Math.max(a.Gc,a.Fa);a.Fa=0;for(var b=a.G.length,c,d;--b;)c=Math.random()*(b+1)|0,d=a.G[b],a.G[b]=a.G[c],a.G[c]=d;a.log("shuffled sequence: "+a.G);a.ec.removeClass().text("");a.Ma.removeClass();a.log("Playing sequence: "+a.G);a.xd.animate({opacity:1},200);"0.5"!==a.oc.css("opacity")&&(b=new TWEEN.Tween({opacity:1}),b.to({opacity:0.5},200),b.delay(200),b.onUpdate(function(){a.oc.css("opacity",this.opacity)}),C(a,b));Da(a)}}
function Da(a){if(a.R){a.Ta=g;for(var b,c,d=500,e=a.Fa+1,f=0;f<e;f++)b=a.G[f],c=a.pc[b],d+=600,function(b,c,d,f){if(a.H)var M=a.Nc[d];d=new TWEEN.Tween({opacity:0.5});d.to({opacity:1},200);d.delay(c);d.onStart(function(){0===f&&a.Ma.removeClass("success");a.H&&(a.log(f+" now playing: ",M),a.source.type=M.type,a.source.frequency.value=M.frequency,a.source.detune.value=M.detune,a.source.connect(a.O),a.O.connect(a.mb),a.mb.connect(a.la.destination),a.source.noteOn(0))});d.onUpdate(function(){b[0].style.opacity=
this.opacity});var U=new TWEEN.Tween({opacity:1});U.to({opacity:0.5},200);U.delay(c+300);U.onUpdate(function(){b[0].style.opacity=this.opacity});U.onComplete(function(){f===e-1&&(a.Ta=k,a.ec.text(e),a.Ma.addClass("your-turn"));a.H&&a.source.disconnect();(1===a.jc||1<a.jc&&0===a.Aa)&&a.ec.addClass("started")});C(a,d);C(a,U)}(c,d,b,f)}};function L(a,b){A(this,"i.mp3");A(this,"o.mp3");q.call(this,a,b,"space",g,g,g);this.H&&(this.rc=new Tuna(this.la),this.Cb=new this.rc.Delay({Id:0,delayTime:0,Nd:0,Hd:0,Gd:20,Cd:0}))}p(L);n=L.prototype;
...
n.n=function(){L.c.n.call(this);this.h=ua(this);this.h.viscosity=0;var a=2*this.d;640>this.d&&(a=this.d/2);for(var b=0;b<a;b++)this.Ba=aa(),this.h.particles.push(new Particle),this.h.particles[b].setRadius(1.4*Math.random()+0.1),this.h.particles[b].pos.x=this.Ba[0]*this.d,this.h.particles[b].pos.y=this.Ba[1]*this.e,this.h.particles[b].vel.x=0,this.h.particles[b].vel.y=0;B(this);this.Db=0;this.Ba=[];this.nc=this.d/2;this.tb=this.e/2;this.ob=this.nc;this.Ga=this.tb;this.Fb=k;this.Hc=g;this.ea=0;this.K=
1;this.Mb=k;this.Oc=g;this.ia=0;this.L=1;0<this.k.height&&(this.Y(),this.Z())};function Ea(a){if(!a.v||!a.v.length)a.v=$("#space-canvas");a.i=a.i||a.v[0];a.i.width=a.d;a.i.height=a.e}
n.uc=function(){L.c.uc.call(this);Ea(this);var a=this,b=new paper.Point(0,0),c=s("move",this.j);$(this.I).bind(c,function(c){c.preventDefault();c.stopPropagation();a.ob=D(c).x;a.Ga=D(c).y;b={x:a.ob,y:a.Ga};a.a.hitTest(b)||a.b.hitTest(b)?a.hasFocus&&(document.body.style.cursor="pointer"):document.body.style.cursor="default"});c=s("down",this.j);$(this.I).bind(c,function(b){b.preventDefault();b.stopPropagation();b=D(b);b=new paper.Point(b.x,b.y);a.Kd=b;a.a.hitTest(b)&&a.hasFocus&&a.m();a.b.hitTest(b)&&
a.hasFocus&&a.p()})};n.z=function(){L.c.z.call(this);var a=s("move",this.j);$(this.I).unbind(a+".space");a=s("down",this.j);$(this.I).unbind(a+".space")};n.F=function(){var a=this.d,b=this.e;L.c.F.call(this,k);a=Math.abs(a-this.d);b=Math.abs(b-this.e);Ea(this);this.nc=this.d/2;this.tb=this.e/2;va(this);if((50<a||50<b)&&this.h)for(b=0;b<this.h.particles.length;b++)this.Ba=aa(),this.h.particles[b].pos.x=this.Ba[0]*this.d,this.h.particles[b].pos.y=this.Ba[1]*this.e;this.Y();this.Z();z(this)};
function N(a,b,c,d){for(var e=0;e<a.length;e++){b[e]||(b[e]=[]);c[e]||(c[e]=[]);for(var f=0;f<a[e].segments.length;f++)d?(b[e][f]=a[e].segments[f].point.x,c[e][f]=a[e].segments[f].point.y):(a[e].segments[f].point.x=b[e][f],a[e].segments[f].point.y=c[e][f])}}function Fa(a,b,c,d,e,f){var l=100*a.Db,j=1E3*a.Db,y=1E4*a.Db;b<y&&c===g?b+=j:(1<d?b<y&&(b+=l):(c=k,b-=j),d=1<d?d-0.1:1);b<l&&(e=k,c=g,d=1);f===g?(a.ea=b,a.Hc=c,a.K=d,a.Fb=e):(a.ia=b,a.Oc=c,a.L=d,a.Mb=e)}
function O(a,b,c,d,e,f,l){var j=Math.max(a.d,a.e)/(Math.min(a.d,a.e)/2);return c?b+Math.cos(a.ac/10+(d-e))*f*l/j:b+Math.sin(a.ac/10+(d-e))*f*l/j}
n.qa=function(a){L.c.qa.call(this,a);for(a=0;a<this.h.particles.length;a++)this.h.particles[a].pos.x+=(this.nc-this.ob)/(5E3/this.h.particles[a].radius)+0.1,this.h.particles[a].pos.x>2*this.d?this.h.particles[a].pos.x=10*-this.h.particles[a].radius:this.h.particles[a].pos.x<2*-this.d&&(this.h.particles[a].pos.x=this.d+10*this.h.particles[a].radius),this.h.particles[a].pos.y+=(this.tb-this.Ga)/(5E3/this.h.particles[a].radius),this.h.particles[a].pos.y>2*this.e?this.h.particles[a].pos.y=10*-this.h.particles[a].radius:
this.h.particles[a].pos.y<2*-this.e&&(this.h.particles[a].pos.y=this.d+10*this.h.particles[a].radius)};
n.M=function(a){L.c.M.call(this,a);var b;if(this.i){var c=this.i.getContext("2d");c.fillStyle="#e4e4e4";c.clearRect(0,0,this.i.width+1,this.i.height+1);for(b=0;b<this.h.particles.length;b++)c.beginPath(),c.arc(this.h.particles[b].pos.x+0.5,this.h.particles[b].pos.y+0.5,this.h.particles[b].radius,0,2*Math.PI),c.closePath(),c.fill();this.Db=a/100;if(this.Fb===g){Fa(this,this.ea,this.Hc,this.K,this.Fb,g);this.H&&(this.Cb.feedback=this.K/10);for(b=0;b<this.C.length;b++)this.Ba=aa(),this.C[b].segments[0].point.x=
...
n.n=function(){P.c.n.call(this);this.B=s("down","synth");this.s=s("up","synth");var a=this.la;this.source=a.createOscillator();this.gain=a.createGainNode();this.gain.gain.value=0.01;this.rc=new Tuna(a);this.O=a.createAnalyser();this.O.fftSize=512;this.O.smoothingTimeConstant=0.85;this.Tb=$("#waveforms");this.Jd=document.getElementById("oscillator-frequency");this.detune=document.getElementById("oscillator-detune");this.R=k;this.$b={};this.$b.delay=new this.rc.Delay;Ga(this);this.count=360*(this.d%
360);this.Kb=$("#synth-letter-i");this.ha=$("#synth-letter-o");this.$a=1;this.dc=80;this.Jc=650;this.fd=0;this.hd=this.gd=0.5;this.zd=["sine","square","saw","triangle"];var b=this;setTimeout(function(){b.F(g)},800)};
...
n.F=function(a){P.c.F.call(this,k);this.hb=500>this.e?this.e/2+(this.e-256)/2:this.e/2+128;this.scale=~~(0.5*this.e);this.yd=~~(this.e/2);this.i&&(this.i.width=this.d,this.i.height=this.e);this.pb=this.ha.offset();this.Nb=this.ha[0].getBoundingClientRect().width;this.g=this.Nb/2;this.Ia=this.pb.left+this.g;this.qb=this.pb.top+this.g;this.na&&this.S&&(this.Dd=this.na.position.x,this.Ed=this.na.position.y,this.Bb=this.na.bounds.width/2,this.na.position.x=this.Ia,this.na.position.y=this.qb,this.na.scale(this.g/
...
n.w=function(){P.c.w.call(this);var a=this;a.hb=500>a.e?a.e/2+(a.e-256)/2:a.e/2+128;a.scale=~~(0.5*a.e);a.yd=~~(a.e/2);if(!a.path&&!a.Ld){B(a);Math.max(2*a.g,128);var b=2*a.g/128;a.na=new paper.Path.Circle(new paper.Point(a.Ia,a.qb),a.g);a.ib=a.na.clone();a.ib.fillColor="#3777e3";a.ib.opacity=0.9;a.S=new paper.Path.Circle(new paper.Point(a.Ia,a.qb),0.08*a.g);a.S.fillColor="#ffffff";a.S.strokeColor="#ffffff";a.S.strokeColor.alpha=0.3;a.S.strokeWidth=0.05*a.g;a.S.opacity=0.7;a.path=new paper.Path;a.path.strokeColor=
new paper.RgbColor(255,255,255,0.2);a.path.strokeWidth=5;for(var c=0;128>=c;c++){var d=new paper.Point(b*c+a.Ia-a.g,a.hb);a.path.add(d)}a.N=[];a.N.push(a.path);for(b=0;3>b;b++)c=a.path.clone(),a.N.push(c);a.od=new paper.Group(a.na,a.N[0],a.N[1],a.N[2],a.N[3],a.S);a.od.clipped=g;a.duration=0}a.R=k;Ha(a);a.Kb.bind(this.s,function(){a.$a++;a.$a=3<a.$a?0:a.$a;Ga(a);$(".on",a.Tb).removeClass("on");$("."+a.zd[a.$a],a.Tb).addClass("on")});a.ha.bind(this.B,function(){a.Pc=g;a.dc=Ia(a,event.pageX,event.pageY)});
a.ha.bind(this.s,function(){Ja(a);Ka(a);a.Pc=k});b=s("move",this.j);a.ha.bind(b,function(){a.Pc&&(Ja(a),Ka(a))});a.pb=a.ha.offset();a.Nb=a.ha[0].getBoundingClientRect().width};n.z=function(){P.c.z.call(this);this.Kb.unbind(this.s);this.ha.unbind(this.B);this.ha.unbind(this.s);var a=s("move",this.j);this.ha.unbind(a);this.R=g;Ha(this)};function Ga(a){a.source.type=a.$a;a.source.frequency.value=a.dc;a.source.detune.value=a.Jc}
function Ha(a){if(a.R)a.source.disconnect(),a.R=k;else{var b=a.la;a.source.connect(a.$b.delay.input);a.$b.delay.connect(a.O);a.O.connect(a.gain);a.gain.connect(b.destination);a.source.noteOn(0);a.R=g}}function Ja(a){var b=event;Ia(a,b.pageX,b.pageY);Ga(a)}function Ka(a){var b=event;a.S.position.x=b.pageX;a.S.position.y=b.pageY}function Ia(a,b,c){b=(b-a.pb.left)/a.Nb;c=(c-a.pb.top)/a.Nb;a.dc=1E3-1E3*c;a.Jc=-4800+9600*b;a.fd=60-60*c;a.hd=c;a.gd=b};function Q(a,b){A(this,"rocket-launch.mp3");A(this,"rumble.mp3");A(this,"sci-fi-door.mp3");q.call(this,a,b,"rocket",g,g,k);var c=this.find(".letter-i"),d=this.find(".letter-o");this.xc=d.attr("cx")+", "+d.attr("cy");this.gb=c.attr("cx")+", "+c.attr("cy");this.lc=this.find(".letter-i-wrapper");this.gc=$("#moon-1");this.lb=$("[id*=fire-]").css("opacity",0);this.kd=this.lb.length;this.ua=0;this.Gb=this.cc=k}p(Q);
Q.prototype.p=function(){Q.c.p.call(this);if(!this.Gb)if(this.ua<this.kd){if(!this.Gb){var a=this;this.l("rumble.mp3");this.lb[this.ua].style.opacity=1;this.lb[this.ua+1].style.opacity=1;this.lb[this.ua+2].style.opacity=1;var b=~~Random(2,2*this.ua+2),c=new TWEEN.Tween({rotate:0});c.to({rotate:-b},100);c.onUpdate(function(){a.o.attr("transform","rotate("+this.rotate+", "+a.gb+")")});var d=new TWEEN.Tween({rotate:-b});d.to({rotate:b},200);d.delay(100);d.onUpdate(function(){a.o.attr("transform","rotate("+
this.rotate+", "+a.gb+")")});b=new TWEEN.Tween({rotate:b});b.to({rotate:0},100);b.delay(300);b.onUpdate(function(){a.o.attr("transform","rotate("+this.rotate+", "+a.gb+")")});b.onComplete(function(){a.ua+=3;a.Gb=k});this.Gb=g;C(this,c);C(this,d);C(this,b)}}else if(!this.cc){this.l("rocket-launch.mp3");var e=this,c=100,d=this.X[0].getBoundingClientRect(),b=this.o[0].getBoundingClientRect(),f=~~(d.left+d.width/2-b.height);prevTransform=transform="";(new TWEEN.Tween({translateY:0})).to({translateY:20},
400);d=new TWEEN.Tween({rotate:0});d.to({rotate:90},c);d.onUpdate(function(){e.o.attr("transform","rotate("+this.rotate+", "+e.gb+")")});b=new TWEEN.Tween({translateY:0,scale:1});b.to({translateY:f,scale:0.25},400);b.delay(c);b.onUpdate(function(){transform="scale("+this.scale+") translate(0, "+-1*this.translateY+")";e.lc.attr("transform",transform)});b.onComplete(function(){prevTransform=transform});c+=400;f=new TWEEN.Tween({rotate:0});f.to({rotate:-90},400);f.delay(c);f.onUpdate(function(){transform=
prevTransform+" rotate("+this.rotate+", "+e.gb+")";e.lc.attr("transform",transform)});f.onComplete(function(){e.lb.css("opacity",0);e.m()});var c=c+400,l=new TWEEN.Tween({opacity:0});l.to({opacity:1},200);l.delay(c+400+2E3);l.onStart(function(){e.lc.attr("transform","");e.o.attr("transform","")});l.onUpdate(function(){e.o.css("opacity",this.opacity)});l.onComplete(function(){e.ua=0;e.cc=k});this.cc=g;C(this,d);C(this,b);C(this,f);C(this,l)}};
Q.prototype.m=function(){Q.c.m.call(this);this.l("sci-fi-door.mp3");var a=this,b=this.gc[0].style[a.ca].split("rotate(")[1],b=parseInt(b)||0,c=new TWEEN.Tween({rotate:b});c.to({rotate:b+720},1E3);c.onUpdate(function(){a.gc.attr("transform","rotate("+this.rotate+", "+a.xc+")")});c.onComplete(function(){a.gc.attr("transform","rotate(0, "+a.xc+")")});C(a,c)};function R(a,b){A(this,"i.mp3");A(this,"o.mp3");q.call(this,a,b,"ascii",g,g,g)}p(R);n=R.prototype;n.p=function(){R.c.p.call(this);this.za(this.b,this.t,10);this.l("i.mp3")};n.m=function(){R.c.m.call(this);this.za(this.a,this.t,10);this.l("o.mp3")};
n.Y=function(){this.b&&this.b.remove();var a=new paper.Point(this.fa,this.ga),b=new paper.Size(this.q,this.J),a=new paper.Rectangle(a,b);this.b=new paper.Path.Rectangle(a);this.b.closed=g;this.b.vectors=[];for(a=0;a<this.b.segments.length;a++)b=this.b.segments[a].point.clone(),b=b.subtract(this.W),b.velocity=0,b.acceleration=5*Math.random()+10,b.bounce=0.1*Math.random()+1.05,this.b.vectors.push(b)};
...
function La(a){a.La?(a.Rb.x=a.Vc,a.Rb.y=a.Wc,a.Qb.x=a.Tc,a.Qb.y=a.Uc,a.La.segments[0].point=a.Rb,a.La.segments[1].point=a.Qb,a.La.strokeWidth=a.Xc):(a.Rb=new paper.Point(a.Vc,a.Wc),a.Qb=new paper.Point(a.Tc,a.Uc),a.La=new paper.Path,a.La.strokeWidth=a.Xc,a.La.strokeColor="#ebebeb",a.La.add(a.Rb,a.Qb))}n.n=function(){R.c.n.call(this);this.h=ua(this);B(this,g);this.t=new paper.Point(this.Xa,this.xa);0<this.k.height&&(La(this),this.Y(),this.Z())};
...
n.M=function(a){R.c.M.call(this,a);var b=this.k;a=document.getElementById("ascii-canvas");if(b.width&&!(1>b.width)&&b.height&&!(1>b.height)){var c=b.width,d=b.height,e=b.getContext("2d"),f=e.getImageData(0,0,c,d).data;e.clearRect(0,0,b.width+1,b.height+1);b="";for(e=0;e<d;e+=16){for(var l=0;l<c;l+=8){var j=4*(e*c+l),y=f[j],Ua=f[j+1],M=f[j+2],j=Ma[0===f[j+3]?0:Ma.length-1-Math.round((0.3*y+0.59*Ua+0.11*M)/255*(Ma.length-1))];" "==j&&(j="&nbsp;");b+=j}b+="\n"}a.innerHTML=b}};var Ma=" .[]{}@!=-$%^&();:',golei2013".split("");var Na=2*Math.PI;function S(a,b){A(this,"1.mp3");A(this,"2.mp3");q.call(this,a,b,"pong",g,g,g);this.ud=this.ma=250;this.jd=800;this.td=this.Ea=30;this.md=10;this.Qc=40;this.Ka=80;this.ic=40;this.ja=160;this.Pb=g;this.bottomWallOpacity_=this.rightWallOpacity_=this.topWallOpacity_=0}p(S);n=S.prototype;
n.n=function(){S.c.n.call(this);var a=ua(this);a.viscosity=0;this.f=this.f||new Particle;a.particles.push(this.f);this.Sc=this.d/2;this.rd=this.e/2;this.ob=this.Sc;this.Ga=this.rd;this.Ka=this.Ga-this.ja/2;Oa(this)};function Oa(a){a.topWallOpacity_=0;a.rightWallOpacity_=0;a.bottomWallOpacity_=0;a.Ea=a.td;a.ma=a.ud;a.vd=a.Sc-a.d/4;a.f.setRadius(a.Ea);a.f.pos.x=a.vd;a.f.pos.y=a.Ea;a.f.vel.x=a.ma;a.f.vel.y=a.ma;Pa(a,0)}
n.F=function(a){S.c.F.call(this,k);this.i&&(this.i.width=this.d,this.i.height=this.e);a&&z(this)};
n.w=function(){S.c.w.call(this);this.Oa=document.getElementById("bonus");this.Ub=$("#score");this.v=$("#pong-canvas");this.i=this.v[0];this.i.width=this.d;this.i.height=this.e;this.r=this.i.getContext("2d");var a=this,b=s("move",this.j);this.v.bind(b,function(b){b.preventDefault();b.stopPropagation();a.ob=D(b).x;a.Ga=D(b).y});this.bc=this.bc||0;this.bc++;Pa(this,0);this.Oa.style.opacity=0;this.Oa.style[this.ca]="translateX(50px)";this.Pb=k};n.z=function(){S.c.z.call(this);var a=s("move",this.j);this.v.unbind(a)};
function Qa(a,b){a.l("1.mp3");var c=b+"Opacity_",d={};d[c]=a[c];var e={};e[c]=1;d=new TWEEN.Tween(d);d.to(e,200);d.onUpdate(function(){a[c]=this[c]});C(a,d)}function Pa(a,b){a.mc=b;a.Ub&&a.Ub.length&&a.Ub.text(a.mc)}
n.qa=function(a){if(!this.Pb){S.c.qa.call(this,a);var b=this.Ka,c=this.Ga;c<this.ja/2?c=this.ja/2:c>this.e-this.ja/2&&(c=this.e-this.ja/2);this.Ka=b+0.7*(c-b)*10*a;0<this.f.vel.x&&(this.Ea>=this.md&&(this.Ea*=0.9995,this.f.setRadius(this.Ea)),this.ma<=this.jd&&(this.ma*=1.001,this.f.vel.x=this.ma,this.f.vel.y=0>this.f.vel.y?-this.ma:this.ma));if(this.f.pos.x<=this.f.radius){var d=this;d.log("You Lose");d.ra("lost",d.mc);d.ra("game number",d.bc);d.Pb=g;sa(d,function(){Oa(d);d.Pb=k})}else if(0<this.f.vel.x&&
this.f.pos.x>=this.d-this.f.radius&&(this.f.vel.x*=-1,Qa(this,"rightWall")),0<this.f.vel.y&&this.f.pos.y>=this.e-this.f.radius&&(this.f.vel.y*=-1,Qa(this,"bottomWall")),0>this.f.vel.y&&this.f.pos.y<=this.f.radius&&(this.f.vel.y*=-1,Qa(this,"topWall")),a=this.Ka-this.ja/2,b=this.Ka+this.ja/2,0>this.f.vel.x&&this.f.pos.x<=this.Qc+this.ic/2+this.f.radius&&this.f.pos.y>=a&&this.f.pos.y<=b){this.f.vel.x*=-1;a=this.f.vel.mag();this.Ha?this.Ha.copy(this.f.vel):this.Ha=this.f.vel.clone();this.Ha.norm();this.Xb=
this.Xb||new Vector;this.Xb.set(0,(this.f.pos.y-this.Ka)/(this.ja/2));this.Ha.add(this.Xb);this.Ha.norm();this.Ha.scale(a);this.f.vel.copy(this.Ha);var e=this;e.l("2.mp3");a=e.mc+1;0<e.topWallOpacity_&&(0<e.rightWallOpacity_&&0<e.bottomWallOpacity_)&&(a+=10,b=new TWEEN.Tween({opacity:0,translateX:50}),b.to({opacity:1,translateX:0},200),b.onUpdate(function(){e.Oa.style.opacity=this.opacity;e.Oa.style[e.ca]="translateX("+this.translateX+"px)"}),c=new TWEEN.Tween({opacity:1,translateX:0}),c.to({opacity:0,
...
C(e,a)}}};
n.M=function(a){S.c.M.call(this,a);this.i&&(this.r.clearRect(0,0,this.i.width+1,this.i.height+1),this.r.fillStyle="#e0493e",this.r.beginPath(),this.r.arc(this.f.pos.x,this.f.pos.y,this.f.radius,0,Na),this.r.fill(),this.r.fillStyle="#d0d0d0",this.r.fillRect(this.Qc-this.ic/2,this.Ka-this.ja/2,this.ic,this.ja),this.r.fillStyle="#f3cdca",0<this.topWallOpacity_&&(this.r.save(),this.r.globalAlpha=this.topWallOpacity_,this.r.fillRect(0,0,this.d,10),this.r.restore()),0<this.bottomWallOpacity_&&(this.r.save(),
this.r.globalAlpha=this.bottomWallOpacity_,this.r.fillRect(0,this.e-10,this.d,10),this.r.restore()),0<this.rightWallOpacity_&&(this.r.save(),this.r.globalAlpha=this.rightWallOpacity_,this.r.fillRect(this.d-10,0,10,this.e),this.r.restore()))};function T(a,b){A(this,"strike.mp3");A(this,"whoosh-1.mp3");q.call(this,a,b,"bowling",g,g,k)}p(T);T.prototype.n=function(){T.c.n.call(this);this.xb=this.find(".letter-o-wrapper");this.yc=this.X.attr("cx");this.zc=this.X.attr("cy");this.wc=[this.yc,this.zc];this.ka=[this.o.attr("cx"),this.o.attr("cy")];this.Hb=k};
...
(0<=window.location.href.indexOf("modes")||r)&&$(function(){var a=window.location.href.split("/"),b=a[a.length-1].replace("_test.html",".html").replace(/\.html(.*)/,"");if((a=v[b])&&a.Va){var c=$(window).width(),d=$(window).height();1>d&&(d=c);b=$("<div></div>").addClass("mode").addClass(b+"-mode");b.css({width:c,height:d});$("body > *").wrapAll(b);window.currentMode=new a.Va($(".mode")[0],r?"../../":"../");$(window).resize(ea(function(){$(".mode").css({width:$(window).width(),height:$(window).height()});
window.currentMode.F(g)}))}});function W(){this.qc=Modernizr.prefixed("transform");this.sa=$(window);this.e=this.d=0;var a=this;this.sa.resize(ea(function(){Ra(a)}));Ra(this);if(Modernizr.touch){document.body.style[Modernizr.prefixed("userSelect")]="none";document.body.style[Modernizr.prefixed("userDrag")]="none";document.body.style[Modernizr.prefixed("tapHighlightColor")]="rgba(0,0,0,0)";var b=s("move","app");this.sa.bind(b,function(a){a.preventDefault();a.stopPropagation()});b=s("up","app");this.sa.bind(b,function(a){a.preventDefault();
a.stopPropagation()});b=s("down","app");this.sa.bind(b,function(a){a.preventDefault();a.stopPropagation()});this.sa.bind("dblclick.app",function(a){a.preventDefault();a.stopPropagation()})}a.hc=m();Sa(a,"home",k)}function Ra(a){a.d=a.sa.width();a.e=a.sa.height();$("#wrapper").css({width:a.d,height:a.e});if(a.wa)for(var b in a.wa)if(a.wa.hasOwnProperty(b)){var c=a.wa[b];c.V&&(c.V.style.width=a.d+"px",c.V.style.height=a.e+"px");c.Sa&&c.Sa.F(g)}}
W.prototype.postMessage=function(a){a.name.match(/.ready/)?this.hc(a):"goToMode"===a.name?Sa(this,a.data,g):"goToHome"===a.name&&Sa(this,"home",g,g)};
function Sa(a,b,c,d){a.wa=a.wa||{};a.wa[b]=a.wa[b]||{name:b};var e=a.wa[b],f,l=a.Dc;if(!(l&&l.name==e.name))if(l&&(l.Sa.postMessage({name:"unfocus",data:h}),l.V.style.kc="none"),f=c?function(){e.Sa.postMessage({name:"focus",data:h});var b=d?-a.d:a.d;e.V.style[a.qc]=Ta(b);e.V.style.visibility="visible";setTimeout(function(){var c=new TWEEN.Tween({translateX:b});c.to({translateX:0},800);c.easing(TWEEN.Easing.Exponential.InOut);c.onUpdate(function(){e.V.style[a.qc]=Ta(this.translateX)});c.onComplete(function(){e.V.style.kc=
"auto"});c.start();if(l){var c=-b,d=new TWEEN.Tween({translateX:0});d.easing(TWEEN.Easing.Exponential.InOut);d.to({translateX:c},800);d.onUpdate(function(){l.V.style[a.qc]=Ta(this.translateX)});d.onComplete(function(){l.V.style.visibility="hidden"});d.start()}u.app=[a,a.qd];oa()},10)}:function(){e.Sa.postMessage({name:"focus",data:h});e.V.style.visibility="visible";e.V.style.kc="auto"},e.Sa)a.Dc=e,"function"===typeof f&&f();else{a.hc=function(a){a.name===e.name+".ready"&&"function"===typeof f&&f();
this.hc=m()};var j=document.createElement("div");j.className="mode "+e.name+"-mode";j.style.visibility="hidden";j.style.kc="none";j.style.width=a.d+"px";j.style.height=a.e+"px";b="modes/"+e.name+".html?"+ +new Date;r&&(b="../../"+b);$.ajax({url:b,type:"GET",dataType:"html",complete:function(b,c,d){d=b.responseText;if(b.isResolved()){b.done(function(a){d=a});b=d.split("<body>")[1];b=b.split("</body>")[0];$(j).html(b).appendTo($("#wrapper"));if((b=v[e.name])&&b.Va)e.Sa=new b.Va(j,r?"../../":"");a.Dc=
e;e.V=j}}})}}W.prototype.ra=function(a,b){da("app",a,b)};function Ta(a){return Modernizr.Fd?"translate3d("+a+"px, 0, 0)":"translate("+a+"px, 0)"}W.prototype.qd=function(){TWEEN.update()||(delete u.app,oa())};window.ww=window.ww||{};window.ww.app=window.ww.app||{};window.ww.app.Core=W;var X=["ww","app","Core"],Y=this;!(X[0]in Y)&&Y.execScript&&Y.execScript("var "+X[0]);for(var Z;X.length&&(Z=X.shift());){var Va;if(Va=!X.length)Va=void 0!==W;Va?Y[Z]=W:Y=Y[Z]?Y[Z]:Y[Z]={}};
