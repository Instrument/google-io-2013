...
this.x+"px, "+this.y+"px) ",b=b+("scale("+this.scale+")");a.X[0].style[a.ca]=b});C(this,c);C(this,b)};function G(a,b){A(this,"bacon-sizzle.mp3");A(this,"egg-cracked.mp3");A(this,"cracked-open.mp3");A(this,"eggs-sizzling.mp3");q.call(this,a,b,"bacon",g,g,k)}p(G);G.prototype.n=function(){G.c.n.call(this);this.Yc=g;this.dd=$("#egg-whole").css("opacity",1)[0];this.Cc=$("[id*=crack-]").css("opacity",0);this.Yb=0;this.Ad=this.Cc.length;this.Ed=$("#egg-whites");this.Ra=$("#egg-cracked").css("opacity",0);this.Ac=this.Ra.attr("cx")+", "+this.Ra.attr("cy")};
...
") translate(0, "+this.translateY+")")});C(this,b);C(this,c)};G.prototype.m=function(){G.c.m.call(this);if(this.Yb<this.Ad)this.Cc[this.Yb].style.opacity=1,this.Yb++,this.l("egg-cracked.mp3");else if(this.Yc){this.l("cracked-open.mp3");var a=this,b=new TWEEN.Tween({opacity:1});b.to({opacity:0},200);b.onUpdate(function(){a.dd.style.opacity=this.opacity});b.onComplete(function(){a.Ra.css("opacity",1);a.Yc=k;wa(a)});this.Ra.css("opacity",0);C(this,b)}else this.l("eggs-sizzling.mp3"),wa(this)};
function wa(a){var b=-1*~~(250*Math.random()+20),c=a.Ra.attr("transform")||"",c=parseInt(c.split("rotate(")[1],10)||0,d=~~Random(-20,20),e=new TWEEN.Tween({rotate:c});e.to({rotate:(c+b/2)/window.devicePixelRatio},500);e.easing(TWEEN.Easing.Elastic.In);e.onUpdate(function(){a.Ed.attr("transform","rotate("+(this.rotate-d)+", "+a.Ac+")");a.Ra.attr("transform","rotate("+this.rotate+", "+a.Ac+")")});C(a,e)};function H(a,b){A(this,"brass-note-1.mp3");A(this,"brass-note-2.mp3");A(this,"brass-note-3.mp3");A(this,"brass-note-4.mp3");A(this,"lute-note-1.mp3");A(this,"lute-note-2.mp3");A(this,"lute-note-3.mp3");A(this,"lute-note-4.mp3");A(this,"funky-note-1.mp3");A(this,"funky-note-2.mp3");A(this,"funky-note-3.mp3");A(this,"funky-note-4.mp3");A(this,"beats-piano.mp3");A(this,"beats-club.mp3");A(this,"beats-effected-kit.mp3");A(this,"beats-electric-1.mp3");A(this,"beats-electric-2.mp3");A(this,"beats-hip-hop.mp3");
...
n.Da=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b],d=new paper.Point(this.fa,this.ga);c.velocity=a===this.a?((this.g-c.length)/c.acceleration+c.velocity)/c.bounce:((d.getDistance(this.W)-c.length)/c.acceleration+c.velocity)/c.bounce;c.length=Math.max(0,c.length+c.velocity)}};n.Ca=function(a){for(var b=0;b<a.segments.length;b++){var c=a.vectors[b].clone();a===this.a?(this.a.segments[b].point=c.add(this.A),this.a.smooth()):this.b.segments[b].point=c.add(this.W)}};
n.M=function(a){J.c.M.call(this,a);this.Ib||this.Za-this.$c>this.pd&&ya(this);this.b&&this.a&&(this.jb(),this.kb());0<a&&(this.b&&this.a)&&(this.Da(this.b),this.Ca(this.b),this.Da(this.a),this.Ca(this.a))};function K(a,b){q.call(this,a,b,"simone",g,g)}p(K);
K.prototype.n=function(){K.c.n.call(this);var a=this;TWEEN.removeAll();this.B=s("down","simone");this.s=s("up","simone");this.wd=Modernizr.touch?"Tap":"Click";this.ub=$("#red");this.vb=$("#green");this.eb=$("#blue");this.fb=$("#yellow");this.pc=[this.ub,this.vb,this.eb,this.fb];this.oc=$("#red, #green, #blue, #yellow").css("opacity",1);this.ec=$("#levels").removeClass().text("");this.Ma=$("#status").removeClass();this.Bd=$("#levels").css("opacity",0);this.Bc=$("#simone");this.message=$("#message").text(this.wd+
...
n.uc=function(){L.c.uc.call(this);Ea(this);var a=this,b=new paper.Point(0,0),c=s("move",this.j);$(this.I).bind(c,function(c){c.preventDefault();c.stopPropagation();a.ob=D(c).x;a.Ga=D(c).y;b={x:a.ob,y:a.Ga};a.a.hitTest(b)||a.b.hitTest(b)?a.hasFocus&&(document.body.style.cursor="pointer"):document.body.style.cursor="default"});c=s("down",this.j);$(this.I).bind(c,function(b){b.preventDefault();b.stopPropagation();b=D(b);b=new paper.Point(b.x,b.y);a.Od=b;a.a.hitTest(b)&&a.hasFocus&&a.m();a.b.hitTest(b)&&
...
n.n=function(){P.c.n.call(this);this.B=s("down","synth");this.s=s("up","synth");var a=this.la;this.source=a.createOscillator();this.gain=a.createGainNode();this.gain.gain.value=0.01;this.rc=new Tuna(a);this.O=a.createAnalyser();this.O.fftSize=512;this.O.smoothingTimeConstant=0.85;this.Tb=$("#waveforms");this.Nd=document.getElementById("oscillator-frequency");this.detune=document.getElementById("oscillator-detune");this.R=k;this.$b={};this.$b.delay=new this.rc.Delay;Ga(this);this.count=360*(this.d%
360);this.Kb=$("#synth-letter-i");this.ha=$("#synth-letter-o");this.$a=1;this.dc=80;this.Jc=650;this.kd=0;this.md=this.ld=0.5;this.Dd=["sine","square","saw","triangle"];var b=this;setTimeout(function(){b.F(g)},800)};
...
n.F=function(a){P.c.F.call(this,k);this.hb=500>this.e?this.e/2+(this.e-256)/2:this.e/2+128;this.scale=~~(0.5*this.e);this.Cd=~~(this.e/2);this.i&&(this.i.width=this.d,this.i.height=this.e);this.pb=this.ha.offset();this.Nb=this.ha[0].getBoundingClientRect().width;this.g=this.Nb/2;this.Ia=this.pb.left+this.g;this.qb=this.pb.top+this.g;this.na&&this.S&&(this.Hd=this.na.position.x,this.Id=this.na.position.y,this.Bb=this.na.bounds.width/2,this.na.position.x=this.Ia,this.na.position.y=this.qb,this.na.scale(this.g/
...
n.w=function(){P.c.w.call(this);var a=this;a.hb=500>a.e?a.e/2+(a.e-256)/2:a.e/2+128;a.scale=~~(0.5*a.e);a.Cd=~~(a.e/2);if(!a.path&&!a.Pd){B(a);Math.max(2*a.g,128);var b=2*a.g/128;a.na=new paper.Path.Circle(new paper.Point(a.Ia,a.qb),a.g);a.ib=a.na.clone();a.ib.fillColor="#3777e3";a.ib.opacity=0.9;a.S=new paper.Path.Circle(new paper.Point(a.Ia,a.qb),0.08*a.g);a.S.fillColor="#ffffff";a.S.strokeColor="#ffffff";a.S.strokeColor.alpha=0.3;a.S.strokeWidth=0.05*a.g;a.S.opacity=0.7;a.path=new paper.Path;a.path.strokeColor=
new paper.RgbColor(255,255,255,0.2);a.path.strokeWidth=5;for(var c=0;128>=c;c++){var d=new paper.Point(b*c+a.Ia-a.g,a.hb);a.path.add(d)}a.N=[];a.N.push(a.path);for(b=0;3>b;b++)c=a.path.clone(),a.N.push(c);a.sd=new paper.Group(a.na,a.N[0],a.N[1],a.N[2],a.N[3],a.S);a.sd.clipped=g;a.duration=0}a.R=k;Ha(a);a.Kb.bind(this.s,function(){a.$a++;a.$a=3<a.$a?0:a.$a;Ga(a);$(".on",a.Tb).removeClass("on");$("."+a.Dd[a.$a],a.Tb).addClass("on")});a.ha.bind(this.B,function(){a.Pc=g;a.dc=Ia(a,event.pageX,event.pageY)});
...
function Ha(a){if(a.R)a.source.disconnect(),a.R=k;else{var b=a.la;a.source.connect(a.$b.delay.input);a.$b.delay.connect(a.O);a.O.connect(a.gain);a.gain.connect(b.destination);a.source.noteOn(0);a.R=g}}function Ja(a){var b=event;Ia(a,b.pageX,b.pageY);Ga(a)}function Ka(a){var b=event;a.S.position.x=b.pageX;a.S.position.y=b.pageY}function Ia(a,b,c){b=(b-a.pb.left)/a.Nb;c=(c-a.pb.top)/a.Nb;a.dc=1E3-1E3*c;a.Jc=-4800+9600*b;a.kd=60-60*c;a.md=c;a.ld=b};function Q(a,b){A(this,"rocket-launch.mp3");A(this,"rumble.mp3");A(this,"sci-fi-door.mp3");q.call(this,a,b,"rocket",g,g,k);var c=this.find(".letter-i"),d=this.find(".letter-o");this.xc=d.attr("cx")+", "+d.attr("cy");this.gb=c.attr("cx")+", "+c.attr("cy");this.lc=this.find(".letter-i-wrapper");this.gc=$("#moon-1");this.lb=$("[id*=fire-]").css("opacity",0);this.od=this.lb.length;this.ua=0;this.Gb=this.cc=k}p(Q);
Q.prototype.p=function(){Q.c.p.call(this);if(!this.Gb)if(this.ua<this.od){if(!this.Gb){var a=this;this.l("rumble.mp3");this.lb[this.ua].style.opacity=1;this.lb[this.ua+1].style.opacity=1;this.lb[this.ua+2].style.opacity=1;var b=~~Random(2,2*this.ua+2),c=new TWEEN.Tween({rotate:0});c.to({rotate:-b},100);c.onUpdate(function(){a.o.attr("transform","rotate("+this.rotate+", "+a.gb+")")});var d=new TWEEN.Tween({rotate:-b});d.to({rotate:b},200);d.delay(100);d.onUpdate(function(){a.o.attr("transform","rotate("+
...
n.M=function(a){R.c.M.call(this,a);var b=this.k;a=document.getElementById("ascii-canvas");if(b.width&&!(1>b.width)&&b.height&&!(1>b.height)){var c=b.width,d=b.height,e=b.getContext("2d"),f=e.getImageData(0,0,c,d).data;e.clearRect(0,0,b.width+1,b.height+1);b="";for(e=0;e<d;e+=16){for(var l=0;l<c;l+=8){var j=4*(e*c+l),y=f[j],Ua=f[j+1],M=f[j+2],j=Ma[0===f[j+3]?0:Ma.length-1-Math.round((0.3*y+0.59*Ua+0.11*M)/255*(Ma.length-1))];" "==j&&(j="&nbsp;");b+=j}b+="\n"}a.innerHTML=b}};var Ma=" .[]{}@!=-$%^&();:',golei2013".split("");var Na=2*Math.PI;function S(a,b){A(this,"1.mp3");A(this,"2.mp3");q.call(this,a,b,"pong",g,g,g);this.yd=this.ma=250;this.nd=800;this.xd=this.Ea=30;this.qd=10;this.Qc=40;this.Ka=80;this.ic=40;this.ja=160;this.Pb=g;this.bottomWallOpacity_=this.rightWallOpacity_=this.topWallOpacity_=0}p(S);n=S.prototype;
n.n=function(){S.c.n.call(this);var a=ua(this);a.viscosity=0;this.f=this.f||new Particle;a.particles.push(this.f);this.Sc=this.d/2;this.vd=this.e/2;this.ob=this.Sc;this.Ga=this.vd;this.Ka=this.Ga-this.ja/2;Oa(this)};function Oa(a){a.topWallOpacity_=0;a.rightWallOpacity_=0;a.bottomWallOpacity_=0;a.Ea=a.xd;a.ma=a.yd;a.zd=a.Sc-a.d/4;a.f.setRadius(a.Ea);a.f.pos.x=a.zd;a.f.pos.y=a.Ea;a.f.vel.x=a.ma;a.f.vel.y=a.ma;Pa(a,0)}
...
function(a){a.preventDefault();a.stopPropagation()}));e.hc=m();Sa(e,"home",k)}}function Ra(a){a.d=a.sa.width();a.e=a.sa.height();$("#wrapper").css({width:a.d,height:a.e});a.ed=Math.floor(a.d/2);a.fd=Math.floor(a.e/2);a.gd=a.ed-197;a.hd=a.fd-149;$(".bounds-fallback").css({left:a.gd,top:a.hd,width:"395px",height:"299px"});if(a.wa)for(var b in a.wa)if(a.wa.hasOwnProperty(b)){var c=a.wa[b];c.V&&(c.V.style.width=a.d+"px",c.V.style.height=a.e+"px");c.Sa&&c.Sa.F(g)}}
...
e;e.V=j}}})}}W.prototype.ra=function(a,b){da("app",a,b)};function Ta(a){return Modernizr.Jd?"translate3d("+a+"px, 0, 0)":"translate("+a+"px, 0)"}W.prototype.ud=function(){TWEEN.update()||(delete u.app,oa())};window.ww=window.ww||{};window.ww.app=window.ww.app||{};window.ww.app.Core=W;var X=["ww","app","Core"],Y=this;!(X[0]in Y)&&Y.execScript&&Y.execScript("var "+X[0]);for(var Z;X.length&&(Z=X.shift());){var Va;if(Va=!X.length)Va=void 0!==W;Va?Y[Z]=W:Y=Y[Z]?Y[Z]:Y[Z]={}};
